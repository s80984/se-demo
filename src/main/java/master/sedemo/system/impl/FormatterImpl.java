...
/**
 * Class that implements the Formatter interface.
 * 
...
class FormatterImpl implements Formatter {
	 ...
	 * EUR currency symbol.
	 */
	private final String EUR = CurrencySymbol.get(Currency.EUR);


	/**
	 * DateFormatter for date formats.
	 */
	private final DateFormat[] dateFmts = {
	 ...
	 */
	private final DateFormat[] timeFmts = {
