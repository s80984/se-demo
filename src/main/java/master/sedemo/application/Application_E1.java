...
//			.line(), orders);
	...
	private void moreOrders() {
		...
		//
		this.articles.addAll(Arrays.asList(pfanne));
		...
		Order o4450 = new Order(eric)
				.setId("4450305661");
		//
		orders.addAll(Arrays.asList(o7356, o4450));
		//
...
//		return sb;
	...
	public TablePrinter printOrder(final TablePrinter orderTable, final Order order) {
		...
		if(orderTable != null && order != null) {
			...
			//
			String itemVATStr = fmtPrice(414);			// "4.14"
			String itemPriceStr = fmtPrice(2596, 1);	// "25.96�" with Euro symbol
